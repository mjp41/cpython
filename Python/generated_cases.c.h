...
// Do not edit!
        ...
        TARGET(STORE_ATTR_SLOT) {
            ...
            *(PyObject **)addr = value;
            ...
            Py_DECREF(owner);
            #line 2831 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            next_instr += 4;
            DISPATCH();
        }
        ...
        TARGET(IMPORT_NAME) {
            ...
            #line 3040 "Python/generated_cases.c.h"
            Py_DECREF(level);
            Py_DECREF(fromlist);
        ...
        TARGET(POP_JUMP_IF_NONE) {
            ...
            #line 3149 "Python/generated_cases.c.h"
                Py_DECREF(value);
        ...
        TARGET(MATCH_KEYS) {
            ...
            #line 3247 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(INSTRUMENTED_FOR_ITER) {
            ...
            #line 3374 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        end_for_iter_list:
            // Common case: no jump, leave it to the code generator
            #line 3401 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = next;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(FOR_ITER_GEN) {
            ...
            DISPATCH_INLINED(gen_frame);
            #line 3484 "Python/generated_cases.c.h"
        }
        ...
        TARGET(BEFORE_WITH) {
            ...
            #line 3561 "Python/generated_cases.c.h"
            Py_DECREF(mgr);
        ...
        TARGET(WITH_EXCEPT_START) {
            ...
            */
            ...
            if (res == NULL) goto error;
            #line 3608 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(PUSH_EXC_INFO) {
            ...
            #line 3627 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(LOAD_ATTR_METHOD_WITH_VALUES) {
            ...
            res = self;
            assert(oparg & 1);
            #line 3658 "Python/generated_cases.c.h"
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
            next_instr += 9;
        ...
        TARGET(LOAD_ATTR_METHOD_NO_DICT) {
            ...
            res = self;
            assert(oparg & 1);
            #line 3682 "Python/generated_cases.c.h"
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
            next_instr += 9;
        ...
        TARGET(CALL) {
            ...
            #line 3833 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_BUILTIN_CLASS) {
            ...
            Py_DECREF(tp);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4037 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_BUILTIN_O) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4079 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4360 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(BINARY_OP) {
            ...
            #line 4706 "Python/generated_cases.c.h"
            Py_DECREF(lhs);
            Py_DECREF(rhs);
        ...
        TARGET(INSTRUMENTED_JUMP_BACKWARD) {
            ...
            INSTRUMENTED_JUMP(next_instr-1, next_instr-oparg, PY_MONITORING_EVENT_JUMP);
            #line 4755 "Python/generated_cases.c.h"
            CHECK_EVAL_BREAKER();
            DISPATCH();
        }
