...
// Do not edit!
        ...
        TARGET(COPY_FREE_VARS) {
            ...
            #line 2024 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(SETUP_ANNOTATIONS) {
            ...
            #line 2202 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(DICT_UPDATE) {
            ...
            #line 2248 "Python/generated_cases.c.h"
            Py_DECREF(update);
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(DICT_MERGE) {
            ...
            #line 2261 "Python/generated_cases.c.h"
                Py_DECREF(update);
            #line 1641 "Python/bytecodes.c"
                if (true) goto pop_1_error;
            }
            #line 2266 "Python/generated_cases.c.h"
            Py_DECREF(update);
            STACK_SHRINK(1);
        ...
        TARGET(LOAD_ATTR_INSTANCE_VALUE) {
            ...
            Py_INCREF(res);
            res2 = NULL;
            #line 2514 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(LOAD_ATTR_MODULE) {
            ...
            Py_INCREF(res);
            res2 = NULL;
            #line 2542 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(LOAD_ATTR_SLOT) {
            ...
            Py_INCREF(res);
            res2 = NULL;
            #line 2609 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(LOAD_ATTR_CLASS) {
            ...
            assert(res != NULL);
            Py_INCREF(res);
            #line 2636 "Python/generated_cases.c.h"
            Py_DECREF(cls);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN) {
            ...
            frame->return_offset = 0;
            DISPATCH_INLINED(new_frame);
            #line 2708 "Python/generated_cases.c.h"
        }
        ...
        TARGET(COMPARE_OP) {
            ...
            #line 2830 "Python/generated_cases.c.h"
            Py_DECREF(left);
            Py_DECREF(right);
            #line 2055 "Python/bytecodes.c"
            if (res == NULL) goto pop_2_error;
            #line 2835 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(CHECK_EXC_MATCH) {
            ...
            #line 2998 "Python/generated_cases.c.h"
            Py_DECREF(right);
        ...
        TARGET(IMPORT_NAME) {
            ...
            #line 3014 "Python/generated_cases.c.h"
            Py_DECREF(level);
            Py_DECREF(fromlist);
        ...
        TARGET(MATCH_MAPPING) {
            ...
            #line 3193 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
        ...
        TARGET(FOR_ITER_GEN) {
            ...
            DISPATCH_INLINED(gen_frame);
            #line 3458 "Python/generated_cases.c.h"
        }
        ...
        TARGET(BEFORE_ASYNC_WITH) {
            ...
            #line 3497 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
        ...
        TARGET(BEFORE_WITH) {
            ...
            #line 3544 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
            stack_pointer[-2] = exit;
            DISPATCH();
        ...
        TARGET(LOAD_ATTR_METHOD_NO_DICT) {
            ...
            res = self;
            assert(oparg & 1);
            #line 3656 "Python/generated_cases.c.h"
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
            next_instr += 9;
        ...
        TARGET(CALL_BOUND_METHOD_EXACT_ARGS) {
            ...
            #line 3829 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_PY_EXACT_ARGS) {
            ...
            frame->return_offset = 0;
            DISPATCH_INLINED(new_frame);
            #line 3864 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_NO_KW_STR_1) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3950 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_TUPLE_1) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3975 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_BUILTIN_CLASS) {
            ...
            Py_DECREF(tp);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4011 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_BUILTIN_O) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4053 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_BUILTIN_FAST) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
                /* Not deopting because this doesn't mean our optimization was
                   ...
                   handle it.
                */
            #line 4099 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_METHOD_DESCRIPTOR_NOARGS) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4376 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(INSTRUMENTED_CALL_FUNCTION_EX) {
            ...
            #line 4429 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_FUNCTION_EX) {
            ...
            #line 4500 "Python/generated_cases.c.h"
            Py_DECREF(func);
            Py_DECREF(callargs);
            Py_XDECREF(kwargs);
            ...
            #line 4507 "Python/generated_cases.c.h"
        ...
        TARGET(COPY) {
            ...
            PyObject *top;
            #line 3381 "Python/bytecodes.c"
            assert(oparg > 0);
            top = Py_NewRef(bottom);
            #line 4653 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = top;
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_JUMP_FORWARD) {
            ...
            #line 4722 "Python/generated_cases.c.h"
            DISPATCH();
        }
