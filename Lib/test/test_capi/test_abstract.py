...
class CAPITest(unittest.TestCase):
    ...
    def test_object_setattr(self):
        ...
        self.assertRaises(TypeError, xsetattr, 42, 'a', 5)
    ...
    def test_object_setattrstring(self):
        ...
        self.assertRaises(TypeError, setattrstring, 42, b'a', 5)
    ...
    def test_object_delattr(self):
        ...
        self.assertRaises(TypeError, xdelattr, 42, 'numerator')
    ...
    def test_object_delattrstring(self):
        ...
        self.assertRaises(TypeError, delattrstring, 42, b'numerator')
